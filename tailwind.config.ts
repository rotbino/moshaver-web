...
const config: Config = {
	...
	theme: {
		extend: {
			...
			// ⭐ فونت‌ها - از CSS variable
			fontFamily: {
				sans: ["var(--font-family)", "sans-serif"],
				"body-md": ["var(--font-family)", "sans-serif"],
				"body-lg": ["var(--font-family)", "sans-serif"],
				"headline-sm": ["var(--font-family)", "sans-serif"],
				"headline-md": ["var(--font-family)", "sans-serif"],
				"headline-lg": ["var(--font-family)", "sans-serif"],
				"label-md": ["var(--font-family)", "sans-serif"],
				"number-data": ["number-font", "monospace"],
				"number-display": ["number-font", "monospace"],

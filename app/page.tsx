...
function HomePageContent() {
    ...
    const renderAdCard = (ad: any) => {
        ...
        return (
            <div key={ad.id}
                 className="bg-surface-container-lowest border border-outline-variant p-3 pt-5 flex flex-col gap-2 rounded-sm group hover:shadow-md transition-shadow min-w-0 relative">
                ...
                <div className="flex items-start justify-between gap-2">
                    <div className="flex items-center gap-3 flex-1 min-w-0">
                        ...
                        <div className="flex flex-col min-w-0 gap-0.5">
                            ...
                            <div className="flex items-center gap-1.5 flex-wrap">
                                <h3 className="font-bold text-sm text-on-surface truncate">{ad.title}</h3>
                                {ad.productType && (
                                    <span className="text-[9px] bg-surface-container-high text-on-surface-variant px-1.5 py-0.5 rounded-full truncate max-w-[100px]">
                                    {ad.productType}
                                </span>
                                )}
                            </div>
                    ...
                    <span className="font-bold text-sm text-primary">
                        ...
                        <button onClick={() => handleContactClick(ad.id)} disabled={isCalling}

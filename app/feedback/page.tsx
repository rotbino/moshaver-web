                ...
                <div className="bg-primary/5 border border-primary/20 rounded-xl p-5 mb-6">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-on-surface-variant dark:text-gray-400 leading-relaxed">
                           اگر پلتفرم امکانی که شما نیاز دارید را ندارد یا آنطور که باید باشد نیست،نیاز خود را در بخش نیازها ارسال کنید تا رسیدگی شود. همچنین می توانید پیشنهاد، انتقاد یا مشکلات سیستم را ارسال کنید.
                        </p>
                    </div>
                </div>
